...
export default function Security() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-8 space-y-4 rounded-2xl shadow-2xl shadow-indigo-500/50">
      ...
      <div className="space-y-6 pt-8 border-t border-white/80">
        ...
        <button className="px-10 py-0.5 font-extralight bg-white text-black rounded-lg hover:bg-white/90 transition-colors">
          Submit
        </button>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-6 pt-6 border-t border-white/80">
        <p className="text-sm font-Inter text-gray-500"> Use a phone app like 1Password, Authy, LastPass Authenticator, or Microsoft Authenticator, etc. to get <br /> 2FA codes when prompted during sign-in. </p>
