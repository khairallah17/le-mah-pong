...
export default function Profile() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-8 space-y-6 rounded-3xl shadow-2xl shadow-indigo-500/50">
      <h2 className="text-sm font-inter text-white mb-6">Account</h2>
